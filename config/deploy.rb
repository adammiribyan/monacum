...
set :application, "monacum"

role :app, "monacum.adammiribyan.com"
role :web, "monacum.adammiribyan.com"
role :db,  "monacum.adammiribyan.com", :primary => true

set :scm, "git"
set :repository,  "git@github.com:adammiribyan/monacum.git"
